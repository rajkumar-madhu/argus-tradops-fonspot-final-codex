...
import {orderPriceText, priceDivisorsText, priceText, time24, timeIstDetail} from '../lib/format.ts';
test('journal time is explicitly IST regardless of host time zone',()=>{
 ...
 try {
  for(const zone of ['UTC','America/New_York','Asia/Kolkata']) {
   ...
   assert.equal(timeIstDetail('2026-06-30T03:53:38Z'),'30 Jun, 09:23:38');
  }
